...
[VolumeComponentMenu("My Post-Processing/Noise Fog")]
public class NoiseFog : CustomPostProcessing
{
    ...
    public MinFloatParameter fogXSpeed = new MinFloatParameter(0.1f, 0f);
    public MinFloatParameter fogYSpeed = new MinFloatParameter(0.1f, 0f);
    public MinFloatParameter noiseAmount = new MinFloatParameter(1.0f, 0f);    

    private Matrix4x4 frustumCorners;   //视锥体近平面的四个角，相对于相机的向量(大小和方向)

    private const string mShaderName = "URP/15_FogWithNoise";
    ...
    public override void Render(CommandBuffer cmd, ref RenderingData renderingData, RTHandle source, RTHandle destination)
    {
        ...
        mMaterial.SetFloat("_FogXSpeed", fogXSpeed.value);
        mMaterial.SetFloat("_FogYSpeed", fogYSpeed.value);
        mMaterial.SetFloat("_NoiseAmount", noiseAmount.value);
